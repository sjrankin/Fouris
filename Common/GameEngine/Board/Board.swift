...
class Board: GameMapProtocol
{
    ...
    public weak var Game: GameLogic? = nil
    
    /// The piece factory.
    public var Factory: PieceFactory? = nil
    
    /// The map of pieces on the board.
    public var Map: MapType? = nil
    ...
    /// Interior top of the bucket.
    public var BucketTopInterior: Int = 0
    /// Interior bottom of the bucket.
    public var BucketBottomInterior: Int = 0
    /// Interior left side of the bucket.
    public var BucketInteriorLeft: Int = 0
    /// Interior right side of the bucket.
    public var BucketInteriorRight: Int = 0
    /// Interior width of the bucket.
    public var BucketInteriorWidth: Int = 0
    /// Interior height of the bucket.
    public var BucketInteriorHeight: Int = 0
    /// Bottom of the bucket.
    public var BucketBottom: Int = 0
    ...
    public func RotationSuccess(ID: UUID, Direction: Directions)
    {
    ...
    public func MapIsEmpty(At: CGPoint, Item: inout PieceTypes) -> Bool
    {
    ...
    public func DistanceToBottom(From: CGPoint) -> Int
    {
    ...
    public func ExecuteDropDown(By: Int, WithPiece: Piece)
    {
    ...
    @discardableResult public func StartNewPiece2() -> UUID
    {
        if BoardStopped
        {
            return UUID.Empty
    ...
    /// Holds performance data for debug use.
    ...
    public func CannotMove(ID: UUID)
    {
        Game?.PieceCannotMove(ID: ID)
    }
    
    /// Tells the game to discard the specified piece.
    /// - Parameter ThePiece: The piece to be discarded.
    ...
    /// Tells the game to set the opacity of the piece.
    /// - Parameter To: New opacity for the piece.
    ...
    /// Tells the game to set the opacity of the specified piece.
    /// - Parameter GamePiece: The piece whose opacity will be set.
    /// - Parameter To: New opacity for the piece.
    /// - Parameter Duration: Duration of the opacity change, in seconds.
    ...
    /// The ID of the dropped piece.
    public var DroppedID: UUID = UUID.Empty
    
    /// Called when a piece is dropped too far.
    /// - Parameter GamePiece: The piece that dropped too far.
    public func DroppedTooFar(_ GamePiece: Piece)
    {
    ...
    public func NewLocation(ID: UUID)
    {
    ...
    /// Called by a piece when it moves successfully to a new location.
    /// - Parameter ForPiece: The piece that moved.
    /// - Parameter XOffset: Distance piece moved horizontally.
    /// - Parameter YOffset: Distance piece moved vertically.
    public func NewLocation2(ForPiece: Piece, XOffset: Int, YOffset: Int)
    {
    ...
    public func MergedMap() -> MapType.ContentsType
    {
        return Map!.MergeMap()
    }
    ...
    public func CheckForSpecialItems(_ ID: UUID)
    {
    ...
    public func DeleteFrozen(_ ID: UUID)
    {
    ...
    /// Gap count prior to freezing the piece.
    public var PreGapCount: Int = 0
    /// Gap count after freezing the piece.
    public var PostGapCount: Int = 0
    ...
    public func GetPiece(ID: UUID) -> Piece?
    {
    ...
    public func InputFor(ID: UUID, Direction: Directions)
    {
    ...
    public var ValidMotionList = [Directions.Down, Directions.DropDown, Directions.Left, Directions.Right,
                           Directions.RotateRight, Directions.RotateLeft]
    
    /// Set the list of valid motions for the pieces.
    public func SetValidMotions(_ Valid: [Directions])
    {
    ...
    /// Not currently used.
   public  func BucketChanged(X: Int, Y: Int, Node: MapNodes)
    {
        
    }
    
    /// Not currently used.
    public func MapRotated(Right: Bool)
    {
        
    }
    
    /// Not currently used.
    public func BucketRotated(By180: Bool)
    {
        
    }
    
    /// Not currently used.
    public func RowDeleted(Row: Int)
    {
        
    }
    
    /// Not currently used.
    public func GameMapReset()
    {
