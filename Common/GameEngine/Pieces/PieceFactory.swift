...
class PieceFactory
{
    ...
    public static func GetGenericView(ForPiece: Piece, UnitSize: CGFloat = 32.0, WithShadow: Bool = false) -> CAShapeLayer
    {
        ...
        for Normal in Normalized
        {
            ...
            Square.backgroundColor = ColorServer.ColorFrom(ColorNames.Clear).cgColor
            ...
            Square.fillColor = ColorServer.CGColorFrom(ColorNames.White)
            Square.lineWidth = 2.5
            Square.strokeColor = ColorServer.CGColorFrom(ColorNames.Black)
            Square.path = CPath
    ...
    public func Create(_ PieceShape: PieceShapes, WithID: UUID, ForBoard: Board, BaseGame: BaseGameTypes) -> Piece
    {
    ...
    private func RandomLocations(Count: Int, Valid: [Int]) -> [CGPoint]
    {
        var Results = [CGPoint]()
    ...
    static let ShapeIDMap: [PieceShapes: UUID] =
        [
            ...
            PieceShapes.O: UUID(uuidString: "99d6c473-36b5-4504-b6e4-faece29fbe28")!,
