...
class HistoryManager2
{
    ...
    private static var _UserGameStatistics: RunHistory2? = nil
    /// Holds the AI game history class.
    private static var _AIGameStatistics: RunHistory2? = nil
    
    /// Get or set the game history
    public static var GameHistory: RunHistory2?
    {
        get
        {
    ...
    public static var AIGameHistory: RunHistory2?
    {
        get
        {
    ...
    public static func GetHistory(_ IsAI: Bool) -> RunHistory2?
    {
        if IsAI
        {
